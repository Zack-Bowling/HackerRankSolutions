...
/*
birthdayCakeCandle function takes in a vector. It then searches the vector for the largest integer, returns that value
to max_val, and then counts how many times that max integer is present in the vector
 */

int birthdayCakeCandles(vector<int> candles) {
    int max_val = *std::max_element(candles.begin(), candles.end());
    return std::count(candles.begin(), candles.end(), max_val);
